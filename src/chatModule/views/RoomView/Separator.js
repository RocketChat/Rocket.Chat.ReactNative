...
const DateSeparator = ({ ts, unread }) => {
  ...
  if (ts && unread) {
    return (
      <View style={styles.container}>
        <Text style={[styles.text, styles.unreadText, styles.marginLeft]}>
          {date}
        </Text>
        <View
          style={[styles.line, styles.unreadLine, styles.marginHorizontal]}
        />
        <Text style={[styles.text, styles.unreadText, styles.marginRight]}>
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.text, styles.unreadText, styles.marginHorizontal]}>
        {'I18n.t("unread_messages")'}
      </Text>
