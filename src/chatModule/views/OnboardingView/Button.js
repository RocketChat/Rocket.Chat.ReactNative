...
export default class Button extends React.PureComponent {
  ...
  render() {
    const { title, subtitle, type, onPress, icon, testID } = this.props;
    ...
    return (
      ...
      >
        <View
          style={[styles.buttonContainer, styles[`button_container_${type}`]]}
        >
          ...
          <View style={styles.buttonCenter}>
            ...
            {subtitle ? (
              <Text style={[styles.buttonSubtitle, activeStyle]}>
                {subtitle}
              </Text>
            ) : null}
          </View>
