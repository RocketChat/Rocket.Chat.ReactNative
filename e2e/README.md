...
* Edit `e2e/data.js`:
  ...
  * Create a file: `e2e_account.js`, in the same folder as data. Set the `adminUser` and `adminPassword` to an admin user on that environment (or a user with at least create-user and create-c). The example of how to create this file is the `e2e/e2e_account.example.js`
