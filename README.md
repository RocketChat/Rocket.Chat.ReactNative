...
- NodeJS [14.13.1](https://nodejs.org/dist/v14.13.1/docs/api/) (npm v6.14.8)
- yarn [v1.22.10](https://github.com/yarnpkg/yarn/releases/tag/v1.22.10)
- XCode [12.1](https://developer.apple.com/documentation/xcode-release-notes/xcode-12_1-release-notes)
- Java
...
More information can be found [here](https://circle-macos-docs.s3.amazonaws.com/image-manifest/v3985/index.html).
