...
## Whitelabel
Do you want to make the app run on your own server only? [Follow our whitelabel documentation.](https://developer.rocket.chat/guides/developer/mobile-apps/whitelabeling-mobile-apps)
