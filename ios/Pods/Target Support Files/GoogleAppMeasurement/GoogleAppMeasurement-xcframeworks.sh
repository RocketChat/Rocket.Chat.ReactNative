...
install_xcframework "${PODS_ROOT}/GoogleAppMeasurement/Frameworks/GoogleAppMeasurementWithoutAdIdSupport.xcframework" "GoogleAppMeasurementWithoutAdIdSupport" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
