...
import { OutsideStackParamList } from '../types/stacks/OutSideStack';

// Outside
const Outside = createStackNavigator<OutsideStackParamList>();
const _OutsideStack = ({ root }: {root: string}) => {
