...
export default class Video extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <View>
        <TouchableOpacity style={styles.container} onPress={() => this.open()}>
          <Image source={require('../../../static/images/logo.png')} style={styles.image} />
        ...
        <Modal
          ...
          <VideoPlayer source={{ uri }} onBack={() => this.toggleModal()} disableVolume />
        </Modal>
      </View>
    );
  }
