...
export default class Message extends PureComponent {
	...
	renderAttachment() {
		const { attachments, timeFormat, onLongPress } = this.props;
		...
		return attachments.map((file, index) => {
			...
			if (file.image_url) {
				return <Image key={file.image_url} file={file} user={user} baseUrl={baseUrl} customEmojis={customEmojis} onLongPress={onLongPress} />;
			}
			if (file.audio_url) {
				return <Audio key={file.audio_url} file={file} user={user} baseUrl={baseUrl} customEmojis={customEmojis} />;
			}
			if (file.video_url) {
				return <Video key={file.video_url} file={file} user={user} baseUrl={baseUrl} customEmojis={customEmojis} onLongPress={onLongPress} />;
			}
