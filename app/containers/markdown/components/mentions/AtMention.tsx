...
const AtMention = React.memo(({ mention, mentions, username, navToRoomInfo, useRealName, disabled = false, style }: IAtMention) => {
	...
	if (atMentioned) {
		...
		return (
			...
			<Text
				style={[styles.mention, ...(textStyle ? [textStyle] : []), mentionStyle, style, spoilerStyle]}
