...
export const buildParseOptions = (katexEnabled: boolean, dollarSyntax: boolean, parenthesisSyntax: boolean): Options =>
	katexEnabled ? { katex: { dollarSyntax, parenthesisSyntax } } : {};
...
export const useParseOptions = (): Options => {
	...
	return useMemo(
		() => buildParseOptions(katexEnabled, dollarSyntax, parenthesisSyntax),
