...
import { IAutocompleteItemProps, IComposerInputProps, IInputSelection, TSetInput } from '../interfaces';
...
export const ComposerInput = memo(({ inputRef, ref }: IComposerInputProps) => {
