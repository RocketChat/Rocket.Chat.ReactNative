...
export const ActionsButton = () => {
	const { permissionToUpload } = useContext(MessageComposerContext);
			...
			options.push(
				{
					...
					icon: 'camera-photo',
					onPress: () => alert('tbd') // this.takePhoto
				},
				{
					title: I18n.t('Take_a_video'),
					icon: 'camera',
					onPress: () => alert('tbd') // this.takeVideo
				},
				{
					title: I18n.t('Choose_from_library'),
					icon: 'image',
					onPress: () => alert('tbd') // this.chooseFromLibrary
				},
				{
