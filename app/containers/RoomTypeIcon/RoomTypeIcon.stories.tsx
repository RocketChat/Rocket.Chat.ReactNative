...
export const All = () => (
	<>
		...
		<RoomTypeIcon size={30} type='p' abacAttributes={[{ name: 'Attribute', values: ['Value 1', 'Value 2'] }]} />
		<RoomTypeIcon size={30} type='p' abacAttributes={[{ name: 'Attribute', values: ['Value 1', 'Value 2'] }]} teamMain />
