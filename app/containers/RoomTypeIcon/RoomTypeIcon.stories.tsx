...
export const All = () => (
	<>
		...
		<RoomTypeIcon size={30} type='p' abacAttributes={[{ key: 'Attribute', values: ['Value 1', 'Value 2'] }]} />
		<RoomTypeIcon size={30} type='p' abacAttributes={[{ key: 'Attribute', values: ['Value 1', 'Value 2'] }]} teamMain />
