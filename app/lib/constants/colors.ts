...
export const colors = {
	light: {
		...
		conferenceCallOngoingPhoneIcon: '#41FF8B',
		conferenceCallIncomingPhoneIcon: '#2179FF',
		...
		conferenceCallEnabledIconBackground: '#2179FF',
