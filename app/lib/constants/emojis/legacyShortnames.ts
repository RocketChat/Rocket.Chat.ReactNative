// Hand-maintained compatibility map — safe to edit.
//
// Shortnames older clients resolved that emojibase no longer lists. Message reactions and
// the frequently used emojis table store shortnames, so removing an entry makes stored
// ones render as literal `:shortname:` text. Only remove a name once nothing can hold it.
// `scripts/generate-emoji-data.js` reads this file to keep these names searchable.
/* eslint-disable */

export const legacyShortnameToUnicodeMap: { [key: string]: string } = {
