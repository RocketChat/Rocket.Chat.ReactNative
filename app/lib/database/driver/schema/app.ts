...
export const subscriptionsTable = sqliteTable(
	'subscriptions',
	{
		...
		roles: text('roles'),
		unread: real('unread'),
		user_mentions: real('user_mentions'),
		group_mentions: real('group_mentions'),
		tunread: text('tunread'),
		tunread_user: text('tunread_user'),
		tunread_group: text('tunread_group'),
		room_updated_at: real('room_updated_at'),
		ro: integer('ro', { mode: 'boolean' }),
		...
		auto_translate_language: text('auto_translate_language'),
