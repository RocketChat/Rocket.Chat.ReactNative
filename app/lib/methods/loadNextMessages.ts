...
import { IMessage, IRocketChat, TMessageModel } from '../../definitions';
...
export default function loadNextMessages(this: IRocketChat, args: ILoadNextMessages): Promise<IMessage | []> {
