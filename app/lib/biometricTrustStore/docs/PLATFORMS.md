...
| -------------------- | ------------------------------------------------------------------------ |
| Enrollment unchanged | `isEnrollmentValid()` — the silent enrollment key above                  |
...
| Silent at-rest enrollment check                 | `hasEnrollment()` (item deleted on change)    | native enrollment key `isEnrollmentValid()` (`cipher.init`) |
