export default {
    ...
    'error-invalid-email': 'من فضلك أدخل عنوان بريد صحيح {{emai}}',
    'error-invalid-email-address': 'Iمن فضلك أدخل عنوان بريد صحيح',
    ...
    'error-invalid-urls': 'رابط خادم غير صحيح',
    ...
    Confirm: 'تأكيد',
    Connect: 'توصيل',
    Connect_to_a_server: 'اتصال بالخادم',
    Connected: 'متصل',
    connecting_server: 'يتم الاتصال',
    Connecting: '...يتم الاتصال',
    Continue_with: 'استمرار ب',
    Copied_to_clipboard: 'تم نسخ الرسالة',
    Copy: ' نسخ ',
    Permalink: 'رابط ثابت',
    ...
    File_name: 'File name',
    Finish_recording: 'الانتهاء من التسجيل',
    ...
    Share: 'نشر',
    Sign_in_your_server: 'تسجيل الدخول إلى خادمك',
    Sign_Up: 'سجل',
    ...
    Topic: 'موضوع',
    Try_again: 'Try again',
    Two_Factor_Authentication: 'مصادقة مزدوجة',
    ...
    Voice_call: 'مكالمة',
    Welcome: 'أهلا بك',
    Welcome_to_RocketChat: 'Rocket.Chat أهلا بك في ',
