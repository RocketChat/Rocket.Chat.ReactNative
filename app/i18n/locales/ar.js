export default {
	...
	'1_user': 'مستخدم 1',
	'error-action-not-allowed': 'هذا {{action}} غير مسموح',
	...
	'error-importer-not-defined': 'المستورِد غير معرف بطريقة صحيحة، نوع الإستيراد غير معرف',
	...
	'error-push-disabled': 'تنبيهات الإخطار معطلة',
	...
	'error-too-many-requests': 'خطأ، تلقينا الكثير من الطلبات. من فضلك أبطء السرعة. يجب الانتظار لمدة {{seconds}} ثانية قبل المحاولة مرة أخرى',
	...
	'error-user-registration-secret': 'التسجيل مسموح به فقط عبر عنوان الويب السري',
	...
	Desktop_Alert_info: 'هذه التنبيهات ترسل لسطح المكتب',
	Directory: 'مجلد',
	...
	E2E_How_It_Works_info1: 'يمكنك الآن إنشاء مجموعات خاصة ورسائل مباشرة مباشرة. بإمكانك أيضاً إضافة للمجموعات الخاصة والرسائل المباشرة الموجودة مسبقاً',
	E2E_How_It_Works_info2: 'هذا تشفير بين الطرفيات بمعنى أن المفتاح سيستخدم لتشفير وفك تشفير رسائلك ولن يتم حفظه في الخادم. لذلك يترتب عليك حفظ كلمة المرور هذه في مكان آمن',
	E2E_How_It_Works_info3: 'حين الموافقة سيتم إنشاء كلمة المرور بين الطرفيات',
	...
	Encryption_error_desc: 'لم نتمكن من قراءة مفتاح التشفير أثناء الاستيراد',
	...
	Message_HideType_ut: 'انضم المستخدم للمحادثة',
	Message_HideType_wm: 'مرحبا',
	Message_HideType_rm: 'الرسالة حذفت',
	Message_HideType_subscription_role_added: 'تم تعيين دور جديد',
	...
	Onboarding_title: 'مرحبا بك في RocketChat',
	Onboarding_join_open_description: 'انضم لمساحة عملنا للتواصل مع فريق RocketChat ومع المجتمع',
	...
	Open_emoji_selector: 'افتح محدد الايموجي',
	...
	Please_enter_your_password: 'الرجاءإدخال كلمة المرور',
	...
	Reactions: 'التفاعلات',
	Read: 'قراءة',
	Read_External_Permission_Message: 'يحتاج Rocketchat للوصول إلى الصور والملفات الموجودة على الجهاز',
	...
	Receive_notifications_from: 'استلام الاشعارات من {{name}}',
	Resend: 'أعد الإرسال',
	...
	User_unmuted_by: 'المستخدم {{userUnmuted}} ألغي كتمه من قبل {{userBy}}',
	...
	You_need_to_verifiy_your_email_address_to_get_notications: 'يجب تأكيد البريد الإلكتروني حتى تصلك التنبيهات',
	...
	After_seconds_set_by_admin: 'بعد {{seconds}} ثوان (حددها المشرف)',
