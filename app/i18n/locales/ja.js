export default {
	...
	'error-could-not-change-email': 'Eメールを変更できません。',
	'error-could-not-change-name': '名前を変更できません。',
	'error-could-not-change-username': 'ユーザ名を変更できません。',
	...
	'error-email-domain-blacklisted': 'このドメインのEメールはブラックリストに登録されています。',
	'error-email-send-failed': '次のEメールの送信に失敗しました: {{message}}',
	...
	'error-invalid-user': 'ユーザが正しくありません',
	'error-invalid-username': 'ユーザ名が正しくありません',
    ...
    '許可されたユーザーのみが新しいメッセージを書き込めます。他のユーザは返信することができます',
	...
	Clear_cache: 'サーバーのローカルキャッシュをクリア',
	...
	Edit: '編集',
	Edit_Invite: '編集に招待',
	Email_or_password_field_is_empty: 'Eメールかパスワードの入力欄が空です',
	Email: 'Eメール',
	EMAIL: 'Eメール',
	email: 'Eメール',
    ...
    'もしEメールアドレスが登録されていた場合、パスワードのリセット方法を痩身しました。Eメールがすぐに来ない場合、戻ってやり直してください。',
	Forgot_password: 'パスワードを忘れた',
	Forgot_Password: 'パスワードを忘れた',
	Full_table: 'クリックしてテーブル全体を見る',
	Generate_New_Link: '新しいリンクを生成',
	Group_by_favorites: 'お気に入りでグループ',
	Group_by_type: 'タイプでグループ',
	Hide: '隠す',
	...
	Notify_active_in_this_room: 'このルームのアクティブなユーザに通知する',
	Notify_all_in_this_room: 'このルームのユーザ全員に通知する',
	Notifications: '通知',
    ...
    'ユーザ名はメッセージ中であなたにメンションするのに使われます。',
	Settings: '設定',
	...
	Username_is_empty: 'ユーザ名が空です。',
	Username: 'ユーザ名',
	Username_or_email: 'ユーザ名かEメール',
	Validating: '検証中',
	Video_call: 'ビデオ通話',
    ...
    '私達はチャットのコンテンツは決して追跡しません。クラッシュレポートには問題を特定し、修正するために必要な情報のみが含まれます。',
