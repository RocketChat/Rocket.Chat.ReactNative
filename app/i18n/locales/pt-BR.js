export default {
	...
	Clear_all_cookies_from_login_oauth: 'Limpar todos os cookies do OAuth de login?',
	Clear_cookies_desc: 'Esta ação limpará todos os cookies da webview OAuth/SSO, permitindo que você faça login em outras contas via OAuth',
