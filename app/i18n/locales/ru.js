export default {
	...
	Applying_a_theme_will_change_how_the_app_looks: 'Применение темы изменит внешний вид приложения.',
	ARCHIVE: 'АРХИВ',
	archive: 'архив',
	are_typing: 'печатают',
	...
	Dark: 'Темная',
	Dark_level: 'Уровень Темной Темы',
	...
	Desktop_Alert_info: 'Эти уведомления отображаются на рабочем столе',
	...
	is_typing: 'печатает',
	Invalid_or_expired_invite_token: 'Токен приглашение не валидный или с истекшим сроком действия',
	...
	Onboarding_description: 'Сервер это простанство для взаимодействия вашей команды или организации. Уточните адрес сервера у вашего администратора или создайте свой сервер для команды.',
	...
	Reply_in_Thread: 'Ответить в Теме',
	...
	Local_authentication_biometry_fallback: 'Использовать паскод',
	Local_authentication_unlock_option: 'Разблокировать при помощи Паскода',
	Local_authentication_change_passcode: 'Изменить Паскод',
	Local_authentication_info: 'Внимание: Если вы забудете ваш Паскод, вам нужно будет удалить и заново установить это приложение.',
	Local_authentication_facial_recognition: 'распознования лица',
	...
	Passcode_enter_title: 'Введите ваш паскод',
	Passcode_choose_title: 'Выберите ваш новый паскод',
	Passcode_choose_confirm_title: 'Подтвердите ваш новый паскод',
	Passcode_choose_error: 'Паскоды не соответствуют. Попробуйте еще раз.',
	Passcode_choose_force_set: 'Паскод затребован вашим администратором',
