...
'error-duplicate-channel-name':'Un canal ayant pour nom {{channel_name}} existe',
'error-email-domain-blacklisted':'Le domaine de la messagerie est sur liste noire',
...
'error-importer-not-defined':'L'importateur n'a pas été défini correctement, la classe Import est manquante.',
'error-input-is-not-a-valid-field':'{{input}} n'est pas un {{field}} valide',
'error-invalid-actionlink':'Lien d'action invalide',
'error-invalid-arguments':'Arguments invalides',
...
Room_changed_announcement:'L'annonce du canal a été modifiée en : {{announcement}} par {{userBy}}',
Room_changed_description:'Description du canal a été changée en : {{description}} par {{userBy}}',
Room_changed_privacy:'Type du canal a été changé en : {{type}} par {{userBy}}',
Room_changed_topic:'Le sujet du canal a été changé en : {{topic}} par {{userBy}}',
...
Room_name_changed:'Le nom du canal a été changé en : {{name}} par {{userBy}}',
SAVE:'ENREGISTRER',
...
You_can_search_using_RegExp_eg:'Vous pouvez utiliser RegExp. p.ex. `/^text$/i`',
You_colon:'Vous : ',
...
'error-save-image':'Erreur lors de la sauvegarde de l'image',
'error-could-not-change-status':'Impossible de changer de statut',
Contact_your_server_admin:'Contactez l'administrateur de votre serveur.',
connecting_server:'connexion au serveur,
Choose_where_you_want_links_be_opened:'Choisissez où est ce que vous désirez ouvrir les liens',
Change_language_loading:'Changement de langue.',
Click_to_join:'Cliquer pour rejoindre !',
Call_already_ended:'L'appel est déjà terminé !',
creating_invite:'création de l'invitation',
Black:'Noir',
Back:'De retour',
...
A_meaningful_name_for_the_discussion_room:'Un nom ayant du sens pour le canal de discussion',
Clear_cache_loading:'Nettoyage du cache.',
...
Websocket_disabled:'Websocket est désactivé pour ce serveur.\n{{contact}}',
View_Original:'Afficher l’original',
Verify_email_desc:"Nous vous avons envoyé un email pour confirmer votre inscription. Si vous ne recevez pas un e-mail sous peu, veuillez revenir et essayer à nouveau.',
Verify:'Vérifier',
Registration_Succeeded:'Inscrit avec succès !',
This_will_clear_all_your_offline_data:'Ceci effacera vos données hors-ligne.',
Review_this_app:'Noter cette app',
Share_this_app:'Partager cette app',
Version_no:'Version : {{version}}',
Server_version:'Version du serveur : {{version}}',
License:'Licence',
Browser:'Navigateur',
Default_browser:'Navigateur par défaut',
Applying_a_theme_will_change_how_the_app_looks:'En appliquant un thème ceci modifiera l'apparence de l'app.',
Dark:'Sombre',
Light:'Clair',
Theme:'Thème',
Done:'Terminé',
What_are_you_doing_right_now:'Que faîtes-vous en ce moment ?',
Edit_Status:'Modifier le statut',
Choose_file:'Choisir un fichier',
Take_a_video:'Prendre une vidéo',
Send_crash_report:'Envoyer le rapport de crash',
Report:'Signaler',
Message_Reported:'Message signalé',
Mark_unread:'Marquer comme non lu',
Your_message:'Votre message',
Write_External_Permission_Message:'Rocket Chat a besoin d'accéder à votre galerie afin que vous puissiez enregistrer des images.',
Onboarding_description:'Un espace de travail est l'espace de collaboration de votre équipe ou de votre organisation. Demandez à l'administrateur de l'espace de travail une adresse à joindre ou créez-en une pour votre équipe.',
Create_Discussion:'Créer une discussion',
Create_Direct_Messages:'Créer des messages directs',
Threads:'Fils',
replies:'réponses',
Users:'Utilisateurs',
Max_number_of_users_allowed_is_number:'Le nombre maximum des utilisateurs autorisés est de {{maxUsers}}',
...
Verify_your_email_for_the_code_we_sent:'Vérifiez votre messagerie afin d'obtenir le code que nous vous avons envoyé',
Verify_email_title:'Inscrit avec succès !',
EMAIL:'E-MAIL',
Your_workspace:'Votre espace de travail',
Workspaces:'Espaces de travail',
Onboarding_subtitle:'Au delà de la collaboration en équipe',
Onboarding_join_open_description:'Joignez-vous à notre espace de travail pour discuter avec l'équipe de Rocket.Chat et la communauté.',
