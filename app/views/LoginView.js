...
class LoginView extends React.Component {
  ...
  renderTOTP = () => {
    if (/totp/gi.test(this.props.login.error.error)) {
      return (
        <TextInput
  ...
  render() {
    return (
      <KeyboardView contentContainerStyle={styles.container} keyboardVerticalOffset={128}>
        <ScrollView style={styles.loginView} {...scrollPersistTaps}>
          <SafeAreaView>
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity style={styles.buttonContainer} onPress={this.submit}>
                <Text style={styles.button} accessibilityTraits="button">
                  LOGIN
                </Text>
              </TouchableOpacity>
              ...
              <View style={styles.loginSecondaryButtons}>
                <TouchableOpacity style={styles.buttonContainer_inverted} onPress={this.register}>
                  <Text style={styles.button_inverted} accessibilityTraits="button">
                    REGISTER
                  </Text>
                </TouchableOpacity>
              ...
              {this.props.login.failure && (
                <Text style={styles.error}>{this.props.login.error.reason}</Text>
              )}
            </View>
            <Spinner
