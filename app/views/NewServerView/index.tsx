...
import { IStateReducer } from '../../types/state'
...
import { OutsideNavProps } from '../../types/stacks/OutSideStack';
...
interface IProps extends IReduxProps {
	navigation: OutsideNavProps<'OnboardingView'>['navigation'];
	route: OutsideNavProps<'OnboardingView'>['route'];
	theme: TTheme;
}
...
class NewServerView extends React.Component<IProps, IState> {
	...
	onPressServerHistory = (serverHistory: any) => {
		this.setState({ text: serverHistory?.url }, () => this.submit({ fromServerHistory: true, username: serverHistory?.username }));
	}

	submit = async({ fromServerHistory = false, username }: {fromServerHistory: boolean, username: string}) => {
	...
	saveCertificate = (certificate: string) => {
	...
	deleteServerHistory = async(item: any) => {
		...
		console.log('serverHistory', serversHistory);
		const db = database.servers;
		try {
