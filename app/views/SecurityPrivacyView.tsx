			...
			<List.Container testID='security-privacy-view-list'>
				...
				<List.Section>
					...
					<List.Item
						...
						right={() => <Switch value={analyticsEventsState} onValueChange={toggleAnalyticsEvents} testID='security-privacy-view-analytics-events' />}
						additionalAccessibilityLabel={analyticsEventsState}
					/>
					<List.Separator />
					<List.Item
						title='Send_crash_report'
						right={() => <Switch value={crashReportState} onValueChange={toggleCrashReport} testID='security-privacy-view-crash-report' />}
						additionalAccessibilityLabel={analyticsEventsState}
					/>
					<List.Separator />
