...
const registerPushTokenFork = function* registerPushTokenFork() {
	try {
		// Always attempt registration after login. `registerPushToken` deduplicates via
		// `lastToken`/`lastVoipToken`, and will replay any cached token from a prior 401/403.
