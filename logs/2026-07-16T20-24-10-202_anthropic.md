...
- **timestamp**: 2026-07-16T20:24:10.202Z
...
x-claude-code-session-id: c4e2d5b3-1a9b-4602-bb13-8672c99fbfa5
...
```
{"type":"error","error":{"type":"rate_limit_error","message":"Error"},"request_id":"req_011Cd6Mwy9wNUDmrtP2MLtRP"}
```
