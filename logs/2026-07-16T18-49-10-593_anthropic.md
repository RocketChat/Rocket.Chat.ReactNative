...
- **timestamp**: 2026-07-16T18:49:10.593Z
...
- **total request**: 276,663 bytes

**Tools, ranked by size — this is your cut list:**

| tool                                                |  bytes | ~tokens | % of request |
| --------------------------------------------------- | -----: | ------: | -----------: |
| Artifact                                            | 10,178 |  ~2,545 |         3.7% |
| Monitor                                             |  7,767 |  ~1,942 |         2.8% |
| AskUserQuestion                                     |  4,901 |  ~1,225 |         1.8% |
| EnterWorktree                                       |  4,027 |  ~1,007 |         1.5% |
| ScheduleWakeup                                      |  3,838 |    ~960 |         1.4% |
| TaskUpdate                                          |  3,514 |    ~879 |         1.3% |
| Agent                                               |  3,422 |    ~856 |         1.2% |
| TaskCreate                                          |  3,071 |    ~768 |         1.1% |
| SendMessage                                         |  2,777 |    ~694 |         1.0% |
| mcp**atlassian**jira_update_proforma_form_answers   |  2,762 |    ~691 |         1.0% |
| Bash                                                |  2,583 |    ~646 |         0.9% |
| ExitWorktree                                        |  2,511 |    ~628 |         0.9% |
| mcp**argent**run-sequence                           |  2,430 |    ~608 |         0.9% |
| mcp**atlassian**jira_create_issue                   |  2,396 |    ~599 |         0.9% |
| LSP                                                 |  2,307 |    ~577 |         0.8% |
| mcp**atlassian**jira_get_issue                      |  2,281 |    ~570 |         0.8% |
| mcp**atlassian**jira_search                         |  2,183 |    ~546 |         0.8% |
| mcp**atlassian**jira_get_field_options              |  2,002 |    ~501 |         0.7% |
| mcp**atlassian**jira_search_assignable_users        |  1,920 |    ~480 |         0.7% |
| mcp**atlassian**jira_update_issue                   |  1,905 |    ~476 |         0.7% |
| mcp**argent**propose_variant                        |  1,832 |    ~458 |         0.7% |
| mcp**atlassian**jira_get_board_issues               |  1,797 |    ~449 |         0.6% |
| PushNotification                                    |  1,774 |    ~444 |         0.6% |
| mcp**atlassian**jira_get_issue_sla                  |  1,772 |    ~443 |         0.6% |
| TaskList                                            |  1,765 |    ~441 |         0.6% |
| mcp**argent**gesture-custom                         |  1,749 |    ~437 |         0.6% |
| mcp**atlassian**jira_create_remote_issue_link       |  1,740 |    ~435 |         0.6% |
| mcp**argent**react-profiler-analyze                 |  1,679 |    ~420 |         0.6% |
| mcp**argent**describe                               |  1,665 |    ~416 |         0.6% |
| Skill                                               |  1,636 |    ~409 |         0.6% |
| Read                                                |  1,592 |    ~398 |         0.6% |
| TaskOutput                                          |  1,552 |    ~388 |         0.6% |
| mcp**argent**gather-workspace-data                  |  1,495 |    ~374 |         0.5% |
| mcp**atlassian**jira_update_version                 |  1,479 |    ~370 |         0.5% |
| mcp**argent**screenshot-diff                        |  1,478 |    ~370 |         0.5% |
| mcp**atlassian**jira_add_worklog                    |  1,477 |    ~369 |         0.5% |
| mcp**argent**debugger-component-tree                |  1,425 |    ~356 |         0.5% |
| mcp**argent**list-devices                           |  1,423 |    ~356 |         0.5% |
...
| mcp**argent**gesture-rotate                         |  1,239 |    ~310 |         0.4% |
| mcp**argent**profiler-stack-query                   |  1,222 |    ~306 |         0.4% |
| mcp**argent**launch-app                             |  1,193 |    ~298 |         0.4% |
| mcp**atlassian**jira_batch_get_changelogs           |  1,190 |    ~298 |         0.4% |
| mcp**argent**gesture-pinch                          |  1,175 |    ~294 |         0.4% |
| mcp**atlassian**jira_update_sprint                  |  1,172 |    ~293 |         0.4% |
| mcp**argent**react-profiler-stop                    |  1,149 |    ~287 |         0.4% |
...
| Edit                                                |    966 |    ~242 |         0.3% |
| mcp**argent**flow-start-recording                   |    966 |    ~242 |         0.3% |
| mcp**argent**gesture-drag                           |    963 |    ~241 |         0.3% |
| mcp**argent**native-network-logs                    |    959 |    ~240 |         0.3% |
| mcp**atlassian**jira_create_sprint                  |    955 |    ~239 |         0.3% |
| mcp**atlassian**jira_get_issue_images               |    946 |    ~237 |         0.3% |
| mcp**argent**native-view-at-point                   |    938 |    ~235 |         0.3% |
| mcp**argent**gesture-swipe                          |    937 |    ~234 |         0.3% |
| mcp**argent**native-user-interactable-view-at-point |    928 |    ~232 |         0.3% |
| mcp**argent**keyboard                               |    927 |    ~232 |         0.3% |
| mcp**atlassian**jira_create_version                 |    926 |    ~232 |         0.3% |
| mcp**atlassian**jira_get_create_fields              |    906 |    ~227 |         0.3% |
...
| mcp**atlassian**jira_get_project_issue_types        |    687 |    ~172 |         0.2% |
| mcp**atlassian**jira_get_user_profile               |    687 |    ~172 |         0.2% |
| mcp**atlassian**jira_download_attachments           |    670 |    ~168 |         0.2% |
| mcp**argent**flow-add-step                          |    640 |    ~160 |         0.2% |
| Write                                               |    639 |    ~160 |         0.2% |
...
```
{"type":"error","error":{"type":"overloaded_error","message":"Overloaded"},"request_id":"req_011Cd6EhpgF5AH28ELF5MThy"}
```
