...
export default ({ theme }) => {
	...
	return (
		<ScrollView style={{ backgroundColor: themes[theme].auxiliaryBackground }}>
			...
			<RoomItem alert name='thread unread' tunread={new Array(1000)} />
			...
			<RoomItem name='user mentions priority 1' alert unread={1000} userMentions={1} groupMentions={1} tunread={[1]} />
			<RoomItem name='group mentions priority 2' alert unread={1000} groupMentions={1} tunread={[1]} />
			<RoomItem name='thread unread priority 3' alert unread={1000} tunread={[1]} />
